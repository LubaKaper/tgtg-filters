...
export default function Home() {
  ...
  return (
    <div className="max-w-md mx-auto bg-gray-50 min-h-screen flex flex-col">
      ...
      <div className="sticky top-0 z-20 bg-gray-50 px-4 pt-[env(safe-area-inset-top)] space-y-3 pb-3 border-b border-gray-100 shadow-sm will-change-transform">
        {/* Search Bar */}
        <SearchBar
            query={filters.query}
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-[env(safe-area-inset-bottom)]">
        ...
        {activeTab === 'list' ? (
          <div className="space-y-3 py-2">
            ...
            <div className="bg-white rounded-lg p-8 text-center my-4">
